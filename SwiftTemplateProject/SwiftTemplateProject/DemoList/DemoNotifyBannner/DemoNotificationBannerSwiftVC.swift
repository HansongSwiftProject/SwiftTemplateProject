//
//  DemoNotificationBannerSwiftVC.swift
...
class DemoNotificationBannerSwiftVC: UIViewController {
    ...
    internal func selectedQueuePosition() -> QueuePosition {
        let selectedIndex = exampleView.queuePositionSegementedControl.selectedSegmentIndex
...
extension DemoNotificationBannerSwiftVC: NotificationBannerDelegate {
...
extension DemoNotificationBannerSwiftVC: ExampleViewDelegate {
    ...
    internal func basicNotificationCellSelected(at index: Int) {
        ...
        case 3:
            ...
            banner.show(queuePosition: selectedQueuePosition(), bannerPosition: selectedBannerPosition())
        case 4:break
            // FIXME: CustomBannerxxColors 这个类死活没有办法建成，引用
...
//            banner.show(queuePosition: selectedQueuePosition(), bannerPosition: selectedBannerPosition(), on: self)
    ...
    internal func basicStatusBarNotificationCellSelected(at index: Int) {
        ...
        case 4: break
            ...
            //FIXME:哎
//            let banner = StatusBarNotificationBanner(title: "Warning Status Bar Notification Warning Status Bar Notification Displayed Under/Over the Navigation/Tab Bar",  style: .warning, colors:  UIColor.green)
//
