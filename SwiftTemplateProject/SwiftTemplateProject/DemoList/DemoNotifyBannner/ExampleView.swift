...
class ExampleView: UIView {
    ...
    var queuePositionSegementedControl:UISegmentedControl!
    ...
    init(delegate:ExampleViewDelegate) {
        ...
        queuePositionSegementedControl = UISegmentedControl(items: ["Front","Back"])
        queuePositionSegementedControl.selectedSegmentIndex = 1
        queuePositionContentView.addSubview(queuePositionSegementedControl)
        ...
        queuePositionContentView.snp.makeConstraints { (make) in
            ...
            make.bottom.equalTo(queuePositionSegementedControl)
        }
        ...
        queuePositionSegementedControl.snp.makeConstraints { (make) in
        ...
        bannerPositionSegmentedControl.snp.makeConstraints { (make) in
            make.top.equalTo(queuePositionSegementedControl)
            make.width.equalTo(queuePositionSegementedControl)
            make.height.equalTo(queuePositionSegementedControl)
            make.centerX.equalToSuperview()
        }
